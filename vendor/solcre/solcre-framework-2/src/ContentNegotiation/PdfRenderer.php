...
class PdfRenderer extends JsonRenderer {
    ...
    ApiProblemRenderer $apiProblemRenderer, \TCPDF $tcpdf, \Smarty $smarty, Pdf $pdfUtility, ServiceLocatorInterface $serviceLocator, $config, ConfigurationService $columnisConfigurationService
    ) {
    ...
    public function render($nameOrModel, $values = null) {
        ...
        if($nameOrModel instanceof PdfModel) {
            ...
            $footer = 'Generado con '.$this->config['columnis']['PRODUCT'].' '.$this->config['columnis']['VERSION'].' www.solcre.com';
